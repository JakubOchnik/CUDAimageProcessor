...
const std::map<Action, std::string> ACTION_TEXT_NAMES = {
	{Action::crop, "Image cropped: "},
	{Action::brightness, "Changed brightness: "},
	{Action::contrast, "Changed contrast: "},
	{Action::histogram, "Generated histogram"},
	{Action::equalization, "Performed histogram equalization"},
	{Action::invertion, "Inverted colors"},
	{Action::resize, "Resized image: "},
	{Action::lut3d, "Applied LUT"}
};
